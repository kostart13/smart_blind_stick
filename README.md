...
Εκτός από την λειτουργικότητα του μπαστουνιού θα φροντίσουμε και για την εμφανισή του (απόκρυψη καλωδίων, εκτύπωση θήκης για arduino, θήκης για μπαταρία, θήκης για HC-SR04 μέσω 3d printing)
